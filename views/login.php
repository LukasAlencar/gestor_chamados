            ...
            <div style="color: white" class="row d-flex justify-content-center align-items-center h-100">
                ...
                <div
                    ...
                    <form action="../controllers/LoginController.php" method="POST">
                        <h3 class="fw-bold mb-3 title">Entrar</h3>
                        <?php
                        session_start();
                        ...
                        <div data-mdb-input-init class="form-outline mb-4">
                            <input type="text" name="email" id="email"
                                class="form-control form-control-lg fs-6 custom-input" placeholder="Insira seu E-mail" />
                        </div>
                        ...
                        <div class="text-center text-lg-start mt-2 pt-2 w-100">
                            <button type="submit" data-mdb-button-init data-mdb-ripple-init
                                class="custom-btn btn btn-primary btn-md w-100"
                                style="padding-left: 1.5rem; padding-right: 1.5rem;">Entrar</button>
                                <p class="small fw-bold mt-2 pt-1 mb-0 title">Não tem uma conta? <a href="register.php"
                                    class="link link_danger">Cadastre-se</a></p>
                        </div>
                    </form>
                </div>
            </div>
